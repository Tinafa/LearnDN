...
public class UITexture : UIBasicSprite
{
    ...
    public void SetTexture(string path)
    {
        if (texPath != path)
        {
            ...
            {
                mainTexture = XResourceLoaderMgr.singleton.GetSharedResource<Texture>(path, ".png") as Texture;
            }
            DestroyTex(oldTex);
            texPath = path;
        }
    ...
    public void SetRuntimeTexture(Texture tex)
    {
        if (mTexture != tex)
        {
            if (texPath == "" && mTexture != null)
            {
    ...
    private void DestroyTex(Texture tex)
    {
        if (tex != null)
        {
            XResourceLoaderMgr.singleton.UnSafeDestroyShareResource(texPath, ".png", tex);
        }        
    }
}
