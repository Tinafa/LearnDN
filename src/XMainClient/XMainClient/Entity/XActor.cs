...
namespace XMainClient
{
    public abstract class XActor : XCharcacter
    {
        ...
        protected void flip()
        {
            ...
            XMsgCenter.SendMsgUpdateActorPos(this, Mathf.RoundToInt(gameObject.transform.localPosition.x), Mathf.RoundToInt(gameObject.transform.localPosition.y), isToRight);
